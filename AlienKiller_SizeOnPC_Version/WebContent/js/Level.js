...
this.game.coin = 0;
this.coinText = this.add.text(800,10,''+"Coin : 0",{fill:'#DF7401'});
this.coinText.z = 10;
...
this.scoreText = this.add.text(1000, 10, ''+"Kill : 0", { fill: '#DF7401' });
this.scoreText.z = 10;
...
//	this.bg_sun = this.add.image(0,0,"bg1","",this.bg);
	...
	this.BG = this.add.image(0,0,"bg1","",this.bg);
	
	this.BG.width  = this.world.width+10000;
	this.BG.height  = this.world.height+100;
	...
	this.btn1 = this.add.button(1089,15,"button_exit");
...
Level.prototype.createButtons = function() {
	this.btn_right = this.add.button(155,this.game.height-150,"button");
	this.btn_right.anchor.set(1,0);
	this.btn_right.scale.x=-1;
	this.btn_right.alpha = 0.6;
	
	this.btn_left = this.add.button(10,this.game.height-150,"button");
	this.btn_left.alpha = 0.6;
	
	this.btn_jump = this.add.button(this.game.width-100,this.game.height-80,"button");
	this.btn_jump.anchor.set(0.5,0.5);
	this.btn_jump.angle = -270;
	this.btn_jump.alpha = 0.6;
	

	this.btn_spacebar = this.add.button(this.game.width-330,this.game.height-160,"shoot");
