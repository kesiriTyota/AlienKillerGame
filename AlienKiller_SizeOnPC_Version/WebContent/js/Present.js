...
Present.prototype.create = function() {
	...
	var moon = this.add.sprite(430, this.world.centerY,
	"moon");
	...
	var foot = this.add.sprite(this.world.centerX, this.world.centerY+250,
	"foot");
	foot.anchor.set(0.5, 0.5);
	
	var head = this.add.sprite(this.world.centerX, this.world.centerY-350,
	"head");
...
// myGamePiece.angle += 1 * Math.PI / 180; 
	var logo = this.add.sprite(this.world.centerX,-70,"logo_star");
	logo.anchor.set(0.5, 0);
	var twn1 = this.add.tween(logo);
	twn1.to({y:100},2000,"Quad.easeInOut", true, 0);
...
Present.prototype.createButtons = function() {
	//button play
	this.btn_play = this.add.button(this.world.centerX, this.world.centerY-100,"play_menu_1");
	...
	//button story
	this.btn_story = this.add.button(this.world.centerX, this.world.centerY-5,"story_menu_1");
